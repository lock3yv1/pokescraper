...
const http = require("http"); // Added to keep Railway alive

const TELEGRAM_TOKEN = process.env.TELEGRAM_TOKEN;
const TELEGRAM_CHAT_ID = process.env.TELEGRAM_CHAT_ID;

// --- KEEP RAILWAY ALIVE ---
// This creates a tiny web server so Railway doesn't think the app crashed
http.createServer((req, res) => {
  res.writeHead(200);
  res.end("PokéScraper is active");
...
const RRP = {
  ...
  "build and battle": 24.99, "build & battle": 24.99, "pin collection": 34.99,
  "deluxe pin collection": 34.99, "premier deck": 49.99, "display box": 299.99,
  "league battle deck": 39.99, "premium collection": 49.99, "ultra premium collection": 119.99,
  "upc": 119.99,
};
...
const RESELL = {
  ...
  "paldean fates booster box": 140, "151 booster box": 180,
  "151 booster bundle": 55, "151 elite trainer box": 70,
  ...
  "crown zenith booster box": 140, "astral radiance booster box": 130,
  "chilling reign booster box": 160, "battle styles booster box": 180,
  "shining fates booster box": 250, "vivid voltage booster box": 150,
  "darkness ablaze booster box": 140, "hidden fates booster box": 400,
  "hidden fates elite trainer box": 120, "champion path elite trainer box": 200,
...
const SEARCH_TERMS = [
  "pokemon tcg ascended heroes", "pokemon tcg destined rivals", "pokemon tcg perfect order",
  "pokemon tcg chaos rising", "pokemon tcg phantasmal flames", "pokemon tcg journey together",
  "pokemon tcg prismatic evolutions", "pokemon tcg surging sparks", "pokemon tcg stellar crown",
  "pokemon tcg shrouded fable", "pokemon tcg twilight masquerade", "pokemon tcg temporal forces",
  "pokemon tcg paradox rift", "pokemon tcg obsidian flames", "pokemon tcg paldea evolved",
  "pokemon tcg 151", "pokemon tcg paldean fates", "pokemon tcg evolving skies",
  "pokemon tcg brilliant stars", "pokemon tcg fusion strike", "pokemon tcg lost origin",
  "pokemon tcg silver tempest", "pokemon tcg crown zenith", "pokemon tcg astral radiance",
  "pokemon tcg chilling reign", "pokemon tcg battle styles", "pokemon tcg shining fates",
  "pokemon tcg hidden fates", "pokemon tcg vivid voltage", "pokemon tcg darkness ablaze",
  "pokemon tcg champion path", "pokemon tcg cosmic eclipse",
];
...
async function runScan() {
  ...
  if (!foundSomething) console.log("⬜ No new deals found.");
}
...
console.log("🚀 PokéScraper is running...");
